...
The Mutual Information section in `notes/ml/01_regression/ch03_feature_importance/README.md` has been enhanced to match the depth and pedagogical quality of the Pearson Correlation treatment in Math Under the Hood Ch.7.
...
3. **Verify all images** are created in:
   ```
   notes/ml/01_regression/ch03_feature_importance/img/
   ```
