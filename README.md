...
|---|---|---|---|
| 1 | **DeepLearning.AI — *Deep Learning Specialization* (Coursera, Andrew Ng)** | [MathUnderTheHood](notes/MathUnderTheHood/), [ML](notes/ML/) Ch.1–8 · Ch.15 · Ch.17–18 | Derives the math Coursera states as given; adds production depth Coursera skips. |
...
| 6 | **Stanford Online — *XCS229 / CS229 Machine Learning* (paid professional track)** | [MathUnderTheHood](notes/MathUnderTheHood/) Ch.5–7, [ML](notes/ML/) Ch.5 · Ch.6 · Ch.9 · Ch.11 · Ch.15 | Practical production framing alongside CS229's academic rigor. |
...
| 8 | **MIT / edX — *MicroMasters in Statistics and Data Science*** | [MathUnderTheHood](notes/MathUnderTheHood/) Ch.7, [ML](notes/ML/) Ch.9 · Ch.14 · Ch.15 | Use as warm-up, not substitute — MicroMasters is heavier on pure statistics. |

**Recommended primary pairing:** *DeepLearning.AI Deep Learning Specialization + HuggingFace LLM Course*, using [notes/MathUnderTheHood/](notes/MathUnderTheHood/) to build mathematical intuition and [notes/AI/](notes/AI/) + [notes/AIInfrastructure/](notes/AIInfrastructure/) as the production layer those courses intentionally skip.
...
|---|---|---|
| **Pre-1900s** — *math foundations* | Curves, gradients, and probability had to be invented before "fitting a model" was a coherent idea (Newton/Leibniz → Gauss → Pearson). | [notes/MathUnderTheHood/](notes/MathUnderTheHood/#historical-and-chronological-evolution) — Euclid through Rumelhart, mapped to chapters |
...
| **2017 → today** — *agentic AI* | Once Transformers existed, the next bottleneck moved up the stack: prompting → CoT reasoning → retrieval → tool use → ReAct → multi-agent orchestration. | [notes/AI/AIPrimer.md](notes/AI/AIPrimer.md#how-we-got-here--a-short-history-of-agentic-ai) |
