...
> Each chapter lives under `notes/05-ai_infrastructure/` in its own folder, containing a README and supporting materials.  
...
canonical_chapters: ["notes/05-ai_infrastructure/ch01_gpu_architecture/README.md", "notes/05-ai_infrastructure/ch02_memory_and_compute_budgets/README.md"]
...
**Cross-track links** to AI track for LLM fundamentals are standard. Always reference the specific chapter: `[AI track — Transformer Architecture](../02-ai/ch01_llm_fundamentals/transformers)` for model architecture details.
