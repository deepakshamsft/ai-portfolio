...
| InfoNCE contrastive loss | Embedding training objectives → [RAGAndEmbeddings.md](../02-ai/ch04_rag_and_embeddings/rag-and-embeddings.md) |
| CLIP text encoder inside Stable Diffusion | Tokenisation + transformer encoder → [LLMFundamentals.md](../02-ai/ch01_llm_fundamentals/llm-fundamentals.md) |
...
| Fine-tuning LLaVA on visual instructions | Fine-tuning concepts → [FineTuning.md](../02-ai/ch10_fine_tuning/fine-tuning.md) |
| FID as a distribution-level metric | Evaluation concepts → [EvaluatingAISystems.md](../02-ai/ch08_evaluating_ai_systems/evaluating-ai-systems.md) |
...
| What embeddings are and why cosine similarity matters | [RAGAndEmbeddings.md](../02-ai/ch04_rag_and_embeddings/rag-and-embeddings.md) |
