...
|-------|----------------|
| **ML** | [notes/ML/AUTHORING_GUIDE.md](ml/authoring-guide.md) — canonical style reference (deepest documentation) |
| **AI** | [notes/AI/AUTHORING_GUIDE.md](ai/authoring-guide.md) |
