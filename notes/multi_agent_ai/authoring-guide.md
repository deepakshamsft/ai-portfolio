...
> Each chapter lives under `notes/multi_agent_ai/` in its own folder, containing a README.  
...
canonical_chapters: ["notes/multi_agent_ai/ch01_message_formats/README.md", "notes/multi_agent_ai/ch02_mcp/README.md"]
...
All images in `notes/multi_agent_ai/{ChapterName}/img/`. Dark background `#1a1a2e`.
...
- [notes/ml/authoring-guide.md](../ml/authoring-guide.md) — ML track reference (canonical pedagogical patterns)
- `notes/multi_agent_ai/README.md` — Track overview and chapter index
