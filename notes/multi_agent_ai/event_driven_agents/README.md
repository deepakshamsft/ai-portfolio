...
- [Ch.5 — Shared Memory & Blackboard Architectures](../shared_memory) — fan-in aggregation requires a shared store

## Next

→ [Ch.5 — Shared Memory & Blackboard Architectures](../shared_memory) — how parallel agents read and update shared state without overwriting each other
