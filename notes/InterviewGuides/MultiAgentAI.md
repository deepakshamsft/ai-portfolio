...
- [Agentic AI Interview Guide](AgenticAI.md) — CoT, ReAct, RAG, embeddings, semantic caching
- [AI / ReAct & Semantic Kernel](../AI/ReActAndSemanticKernel/) — SK plugin basics and ReAct pattern fundamentals
- [AI / Safety & Hallucination](../AI/SafetyAndHallucination/) — hallucination mitigation that complements injection defence
