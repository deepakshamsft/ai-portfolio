...
- [Agentic AI Interview Guide](AgenticAI.md) — CoT, ReAct, RAG, embeddings fundamentals
- [Multi-Agent AI Interview Guide](MultiAgentAI.md) — agent protocols, MCP, A2A, event-driven systems
- [AI / LLM Fundamentals](../AI/LLMFundamentals/) — transformer architecture, attention mechanism
- [AI / Fine-tuning](../AI/FineTuning/) — LoRA, full fine-tuning, adapter methods
