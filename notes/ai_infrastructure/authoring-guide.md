...
> Each chapter lives under `notes/ai_infrastructure/` in its own folder, containing a README and supporting materials.  
...
canonical_chapters: ["notes/ai_infrastructure/gpu_architecture/README.md", "notes/ai_infrastructure/memory_and_compute_budgets/README.md"]
...
conformance_check: compare_new_chapter_against_gpu_architecture_and_memory_budgets_before_publishing
...
**Cross-track links** to AI track for LLM fundamentals are standard. Always reference the specific chapter: `[AI track — Transformer Architecture](../ai/llm_fundamentals/transformers)` for model architecture details.
