...
- [ ] **Cross-links**: Add "See also" links to the `Metrics` and `Hyperparameter Tuning` chapters at the bottom of the relevant chapter READMEs (at minimum ch01, ch02, ch05-stacking).
