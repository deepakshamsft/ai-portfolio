...
> For a deeper walk through the multivariate chain rule and Jacobians that make this generalisation rigorous, see [MathUnderTheHood ch06 — Gradient & Chain Rule](../../../MathUnderTheHood/ch06-gradient-chain-rule/).
...
**Next up:** [Ch.2 — Multiple Regression](../ch02-multiple-regression/) extends the model to all 8 California Housing features, cutting MAE from $70k to $55k. We’ll see how feature matrices work, how correlated inputs interact, and why adding more features isn’t always better.
