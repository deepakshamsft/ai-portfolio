...
> **Running theme:** Your two-hidden-layer housing network (Ch.4) trained with Adam (Ch.5) achieves R² = 0.83 on the training set but only 0.67 on the test set. The model has memorised the 200+ training districts rather than learning general pricing patterns. This chapter adds guardrails: L1, L2, Dropout, and Early Stopping.
