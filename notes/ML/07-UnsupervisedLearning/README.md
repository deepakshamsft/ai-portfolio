...
|----|-------|-----------|------------|-------------|
| **1** | [Clustering](ch01-clustering/) | 0.42 | K-Means discovers 5 initial segments; DBSCAN finds noise customers | #1 Partial, #4 ✅ |
| **2** | [Dimensionality Reduction](ch02-dimensionality-reduction/) | 0.48 | PCA + UMAP compress 6D → 2D; clustering in reduced space improves separation | #1 ✅, #2 Partial |
| **3** | [Unsupervised Metrics](ch03-unsupervised-metrics/) | **>0.5 ✅** | Silhouette analysis validates K=5; business names assigned; stability confirmed | **All ✅** |
