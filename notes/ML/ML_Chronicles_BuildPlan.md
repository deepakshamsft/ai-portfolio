...
The **Neural_Chronicles HTML book** has 14 chapters. The notes library expanded beyond the HTML source — Ch.15 (MLE & Loss Functions), Ch.16 (TensorBoard), and Ch.17 (Transformers & Attention) were added as standalone chapters, bringing the total to 17. We're converting each into a standalone, runnable learning module:
