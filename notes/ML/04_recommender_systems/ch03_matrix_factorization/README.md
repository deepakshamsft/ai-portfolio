...
- **[AIInfrastructure/inference_optimization](../../../ai_infrastructure/inference_optimization)**: ALS's embarrassingly parallel structure (solve all users independently, then all items) is the template for distributed training in Spark MLlib and Dask.
