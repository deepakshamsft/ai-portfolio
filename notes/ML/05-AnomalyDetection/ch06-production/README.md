...
- **[Reinforcement Learning](../../06-ReinforcementLearning/)**: Adaptive threshold optimization as a bandit problem
- **[Ensemble Methods](../../08-EnsembleMethods/)**: Deeper dive into boosting, bagging, and stacking
- **[Neural Networks](../../03-NeuralNetworks/)**: Advanced autoencoder architectures (VAE, attention)
