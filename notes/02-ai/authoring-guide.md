...
> Each chapter lives under `notes/02-ai/` in its own folder, containing a .md file and a Jupyter notebook.  
...
canonical_chapters: ["notes/02-ai/ch01_llm_fundamentals/llm-fundamentals.md", "notes/02-ai/ch02_prompt_engineering/prompt-engineering.md"]
...
Store images in `notes/02-ai/{ChapterName}/img/` and reference with relative paths.
...
```bash
python notes/02-ai/gen_scripts/generate_progress_visualizations.py
```
...
All images in `notes/02-ai/{ChapterName}/img/`. Dark background `#1a1a2e` for generated plots.
