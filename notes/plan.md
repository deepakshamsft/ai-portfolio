...
> **Status:** Renaming required — `ml/` → `01-ml/`, `math_under_the_hood/` → `00-math_under_the_hood/`
...
| **2** | Agentic AI | `ai/` | ✅ Complete (Ch.1-10), ⏳ Ch.11 planned | Single-agent systems: RAG, tools, orchestration (11 chapters) |
| **3** | Multi-Agent AI | `multi_agent_ai/` | ✅ Complete | Multi-agent protocols and coordination (7 chapters) |
| **4** | Multimodal AI | `multimodal_ai/` | ✅ Complete | Generative image/video/audio models (13 chapters) |
| **5** | AI Infrastructure | `ai_infrastructure/` | 🔄 Ch.1-5 complete, Ch.6-10 planned | GPU architecture, inference optimization, ML experiment tracking (10 chapters) |
| **6** | DevOps Fundamentals | `devops_fundamentals/` | ⏳ Planned | Generic infrastructure: Docker, Kubernetes, CI/CD (8 chapters) |
...
**Action items:**
- [ ] Rename `notes/ml/` → `notes/01-ml/`
- [ ] Rename `notes/math_under_the_hood/` → `notes/00-math_under_the_hood/`
- [ ] Update all cross-references in READMEs and notebooks
- [ ] Update root README.md with new folder names
- [ ] Update scripts (if any hardcoded paths exist)

**Why:**
- Numerical prefixes enforce pedagogical sequence
- `00-` indicates prerequisite material (math foundations)
- `01-` is the first core track (ML foundations)
- Aligns with repo philosophy of sequential learning
...
| **11** | **Advanced Agentic Patterns** | **Reflection, debate, orchestration** | **Edge case handling <1% error** | ⏳ **Planned** |
...
## Track 3 — Multi-Agent AI (`multi_agent_ai/`)
...
## Track 4 — Multimodal AI (`multimodal_ai/`)
...
## Track 5 — AI Infrastructure (`ai_infrastructure/`)
...
| 6 | Model Serving Frameworks | vLLM, TensorRT-LLM, TGI | Production serving | ⏳ Planned |
| 7 | AI-Specific Networking | NVLink, InfiniBand, RDMA | Multi-GPU inference | ⏳ Planned |
| 8 | Feature Stores | Feast, real-time features | ML data infrastructure | ⏳ Planned |
| 9 | ML Experiment Tracking | MLflow, DVC, model registry | Reproducibility | ⏳ Planned |
| 10 | Production Monitoring | Evidently, drift detection, A/B testing | Production reliability | ⏳ Planned |
...
**Planned completion criteria (Ch.6-10):**
...
## Track 6 — DevOps Fundamentals (`devops_fundamentals/`)
...
|----|-------|-----------------|------------|--------|
| 1 | Docker Fundamentals | Containers, images, Dockerfiles | All apps | ⏳ Planned |
| 2 | Container Orchestration (Docker Compose) | Multi-container apps | 3-tier apps | ⏳ Planned |
| 3 | Kubernetes Basics (Kind) | Pods, services, deployments | Cloud-native apps | ⏳ Planned |
| 4 | CI/CD Pipelines (GitHub Actions) | Automated testing, deployment | All projects | ⏳ Planned |
| 5 | Monitoring & Observability (Prometheus + Grafana) | Metrics, logs, traces | Production systems | ⏳ Planned |
| 6 | Infrastructure as Code (Terraform) | Reproducible infrastructure | Cloud deployments | ⏳ Planned |
| 7 | Networking & Load Balancing (Nginx) | Reverse proxy, failover | Web services | ⏳ Planned |
| 8 | Security & Secrets Management | Secrets rotation, RBAC | Production security | ⏳ Planned |
...
**Track 2 (Agentic AI):**
- [ ] Ch.1-10 complete
- [ ] Ch.11 (Advanced Patterns) complete ← **NEW**
- [ ] Can build RAG pipeline
- [ ] Can build tool-calling agent
- [ ] Can implement reflection pattern ← **NEW**

**Track 3 (Multi-Agent AI):**
- [ ] Ch.1-7 complete
- [ ] Can design agent message protocol
- [ ] Can expose MCP server
- [ ] Can delegate via A2A
...
- [ ] Ch.1-5 complete
- [ ] Ch.6-10 complete ← **Planned**
- [ ] Can estimate VRAM
- [ ] Can quantize models
- [ ] Can deploy with vLLM ← **Planned**

**Track 6 (DevOps):**
- [ ] Ch.1-8 complete ← **Planned**
...
2. **Track 2 Ch.11 planning:**
   - [ ] Review `notes/ai/plan.md` (already created)
   - [ ] Create `notes/ai/advanced_agentic_patterns/` folder
   - [ ] Set up animation infrastructure

3. **Track 5 Ch.9-10 planning:**
   - [ ] Review `notes/ai_infrastructure/plan.md`
   - [ ] Finalize ML experiment tracking content

4. **Track 6 planning:**
   - [ ] Review `notes/devops_fundamentals/plan.md` (already created)
   - [ ] Prioritize Ch.1-4 (Docker, Compose, K8s, CI/CD)

### Short-term (Next 2-4 Weeks)

1. **Track 2 Ch.11 implementation:**
   - Week 1: Write README + notebooks
   - Week 2-3: Generate 8+ animations
   - Week 4: Test and integrate

2. **Track 5 Ch.9 implementation:**
   - Week 1-2: ML experiment tracking (MLflow, DVC)
   - Week 3: Azure supplement
   - Week 4: Ch.10 (Production monitoring)

3. **Track 6 Ch.1-4 implementation:**
   - Week 1-2: Docker + Docker Compose
   - Week 3-4: Kubernetes + CI/CD

### Long-term (Next 2-3 Months)

1. **Complete Track 5 Ch.6-10**
2. **Complete Track 6 Ch.5-8**
3. **Cross-track integration:**
   - Deploy Track 2 agents with Track 6 infra
