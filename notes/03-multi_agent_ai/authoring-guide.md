...
> Each chapter lives under `notes/03-multi_agent_ai/` in its own folder, containing a README.  
...
canonical_chapters: ["notes/03-multi_agent_ai/ch01_message_formats/README.md", "notes/03-multi_agent_ai/ch02_mcp/README.md"]
...
All images in `notes/03-multi_agent_ai/{ChapterName}/img/`. Dark background `#1a1a2e`.
...
- `notes/03-multi_agent_ai/README.md` — Track overview and chapter index
