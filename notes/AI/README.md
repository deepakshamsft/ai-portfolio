...
→ Ch.1 (LLM Fundamentals), Ch.2 (Prompt Engineering), Ch.4 (RAG), Ch.5 (Vector DBs)

**"I need an agent that uses tools"**  
→ Ch.1-2 (Foundations), Ch.6 (ReAct & Semantic Kernel)

**"I need to defend against prompt injection"**  
→ Ch.2 (Prompt Engineering), Ch.7 (Safety & Hallucination)

**"I need to optimize cost and latency"**  
→ Ch.9 (Cost & Latency Optimization)

**"I need production monitoring and evals"**  
→ Ch.8 (Evaluating AI Systems)

### By Constraint

- **#1 Business Value**: Ch.6, Ch.10
- **#2 Accuracy**: Ch.2, Ch.4
- **#3 Latency**: Ch.9
- **#4 Cost**: Ch.9
- **#5 Safety**: Ch.2, Ch.7
- **#6 Reliability**: Ch.8, Ch.10
