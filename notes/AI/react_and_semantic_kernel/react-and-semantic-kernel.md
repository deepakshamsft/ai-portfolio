...
- Ch.8: [Fine-Tuning](../fine_tuning) — domain-specific optimization
- Ch.9: [Safety & Hallucination](../safety_and_hallucination) — content filtering
- Ch.10: [Cost & Latency](../cost_and_latency) — caching, streaming, batch processing
