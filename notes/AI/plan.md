...
- [ ] **Review existing mentions**
  - Audit `prompt_engineering/prompt-engineering.md` §8 (self-critique)
  - Audit `cot_reasoning/cot-reasoning-supplement.md` (Reflexion pattern)
  - Audit `react_and_semantic_kernel/react-and-semantic-kernel-supplement.md` (debate pattern)
...
|---------------|----------------------|---------------------|
| Reflection | Agent A critiques Agent B's output | [Message Formats](../multi_agent_ai/message_formats/) |
| Debate | 3+ agents negotiate via protocol | [A2A](../multi_agent_ai/a2a/) |
| Hierarchical | Orchestrator delegates to specialist agents | [Agent Frameworks](../multi_agent_ai/agent_frameworks/) |
| Tool selection | MCP servers standardize tool access | [MCP](../multi_agent_ai/mcp/) |
