...
For this reason, the new [AudioGeneration](./AudioGeneration/README.md) chapter uses MMS TTS as the first demonstration.
...
| [AudioGeneration](./AudioGeneration/README.md) | CPU-first text-to-speech quick win using a compact pretrained model and a minimal notebook flow | How can you generate speech locally without a GPU? What is the shortest path from text prompt to playable waveform? |
...
|------------------------|-------------------------------|
| Patch embeddings in ViT | Transformer architecture → [ML Ch.18 — Transformers](../ML/03-NeuralNetworks/ch10-transformers/README.md) |
...
| CFG conditioning via cross-attention | Attention mechanics → [ML Ch.18 — Transformers](../ML/03-NeuralNetworks/ch10-transformers/README.md) |
| VAE (encoder-decoder architecture) | Neural network layers + backprop → [ML Ch.4](../ML/03-NeuralNetworks/ch02-neural-networks/README.md) + [ML Ch.5](../ML/03-NeuralNetworks/ch03-backprop-optimisers/README.md) |
...
- [ANIMATION_PLAN.md](./ANIMATION_PLAN.md) - data-flow animation coverage and chapter closeout status
...
|-------------|----------------------------|
| What a transformer is and how attention works | [ML Ch.17 — From Sequences to Attention](../ML/03-NeuralNetworks/ch09-sequences-to-attention/README.md) then [ML Ch.18 — Transformers](../ML/03-NeuralNetworks/ch10-transformers/README.md) |
| What embeddings are and why cosine similarity matters | [RAGAndEmbeddings.md](../AI/RAGAndEmbeddings/RAGAndEmbeddings.md) |
| Basic PyTorch tensor operations (`torch.Tensor`, `.view()`, matrix multiply) | [ML Ch.4 — Neural Networks](../ML/03-NeuralNetworks/ch02-neural-networks/README.md) |
| What a convolutional layer does (for comparison with ViT) | [ML Ch.7 — CNNs](../ML/03-NeuralNetworks/ch05-cnns/README.md) |
