...
>
> **Where you are in the curriculum.** [VisionTransformers](../vision_transformers) gave you the visual encoder. This chapter wires it to a text encoder via contrastive learning, producing a shared image–text embedding space — the substrate for [text-to-image generation](../text_to_image), [zero-shot classification](../generative_evaluation), and every modern [multimodal LLM](../multimodal_llms).
