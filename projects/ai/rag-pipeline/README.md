...
|------|-------------------------------|
| [RAGAndEmbeddings.md](../../../notes/AI/RAGAndEmbeddings/RAGAndEmbeddings.md) | Chunking, embedding, retrieval pipeline |
| [VectorDBs.md](../../../notes/AI/VectorDBs/VectorDBs.md) | FAISS as an IVF-flat index with flat brute-force fallback |
| [EvaluatingAISystems.md](../../../notes/AI/EvaluatingAISystems/EvaluatingAISystems.md) | RAGAS metrics running against a real pipeline |
| [CostAndLatency.md](../../../notes/AI/CostAndLatency/CostAndLatency.md) | Input token count visible in `query.py` output |
