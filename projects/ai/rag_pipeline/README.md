...
|------|-------------------------------|
| [RAGAndEmbeddings.md](../../../notes/ai/rag_and_embeddings/rag-and-embeddings.md) | Chunking, embedding, retrieval pipeline |
| [VectorDBs.md](../../../notes/ai/vector_dbs/vector-dbs.md) | FAISS as an IVF-flat index with flat brute-force fallback |
| [EvaluatingAISystems.md](../../../notes/ai/evaluating_ai_systems/evaluating-ai-systems.md) | RAGAS metrics running against a real pipeline |
| [CostAndLatency.md](../../../notes/ai/cost_and_latency/cost-and-latency.md) | Input token count visible in `query.py` output |
